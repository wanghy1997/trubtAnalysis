...
def calculate_metrics_three_classes(df, label_col, pred_col, prob_cols, class_labels=[0, 1, 2]):
    metrics = {}
    auc_ci_low, auc_ci_high = [0.889,0.874,0.856], [1.000,0.998,0.995]
...
if __name__ == '__main__':
    ...
    df = pd.read_excel('/Users/wanghongyi/Documents/a_6________写作/turbt_论文/Experimentation/data_012_模型判读_35例.xlsx')
